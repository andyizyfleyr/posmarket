...
export const CATEGORY_MAPPING: Record<string, string> = {
  ...
  'Villas & Maisons de Luxe': 'Séjours, Expériences & Immobilier',
  'Appartements de Vacances': 'Séjours, Expériences & Immobilier',
  'Chambres d\'Hôtes': 'Séjours, Expériences & Immobilier',
  'Expériences & Activités': 'Séjours, Expériences & Immobilier',
  'Bureaux & Coworking': 'Séjours, Expériences & Immobilier',
  'Terrains & Parcelles': 'Séjours, Expériences & Immobilier',
  'Mobilier': 'Mobilier & Décoration',
  'Formations Online': 'Produits Digitaux & Services',
  'Services (Freelance)': 'Produits Digitaux & Services',
  'Fichiers & Templates': 'Produits Digitaux & Services',
  'Musique & Audio': 'Produits Digitaux & Services',
  'Logiciels & Apps': 'Produits Digitaux & Services',
  'Sport': 'Sport & Loisirs',
