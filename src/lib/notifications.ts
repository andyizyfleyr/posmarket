...
export const NOTIFICATION_EVENTS: Record<NotificationEvent, EventDefinition> = {
  ...
  COMMANDE_LIVREE: { label: 'Commande livrée', templateName: 'order_delivered', lang: 'fr', optIn: false },
  ...
  ALERTE_STOCK_BAS: { label: 'Stock bas', templateName: 'low_stock', lang: 'fr', optIn: false },
  RUPTURE_STOCK: { label: 'Rupture de stock', templateName: 'out_of_stock', lang: 'fr', optIn: false },
  VENTE_POS: { label: 'Vente en boutique', templateName: 'pos_sale', lang: 'fr', optIn: false },
  ...
  BIENVENUE: { label: 'Bienvenue', templateName: 'welcome', lang: 'fr', optIn: false },
  ABONNEMENT_ACTIVE: { label: 'Abonnement activé', templateName: 'subscription_active', lang: 'fr', optIn: false },
  ABONNEMENT_EXPIRANT: { label: 'Abonnement expirant', templateName: 'subscription_expiring', lang: 'fr', optIn: false },
  ABONNEMENT_EXPIRE: { label: 'Abonnement expiré', templateName: 'subscription_expired', lang: 'fr', optIn: false },
  BOUTIQUE_APPROUVEE: { label: 'Boutique approuvée', templateName: 'store_approved', lang: 'fr', optIn: false },
  BOUTIQUE_REJETEE: { label: 'Boutique rejetée', templateName: 'store_rejected', lang: 'fr', optIn: false },
  VERIFICATION_COMPTE_OK: { label: 'Compte vérifié', templateName: 'account_verified', lang: 'fr', optIn: false },
  NOUVELLE_INSCRIPTION: { label: 'Nouvelle inscription', templateName: 'new_signup', lang: 'fr', optIn: false },
};
