  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#fffaf7] via-white to-[#f8fafc] flex flex-col justify-between selection:bg-[#f56b2a]/20 selection:text-[#f56b2a]">
      ...
      <header className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex items-center justify-between">
        ...
        <Link
          href="/"
          className="inline-flex items-center gap-1.5 px-4 py-2 text-xs font-semibold text-gray-700 hover:text-gray-900 bg-white/90 hover:bg-white border border-gray-200/80 rounded-full shadow-sm backdrop-blur-sm transition-all"
        >
      ...
      <main className="flex-grow flex items-center justify-center px-4 sm:px-6 py-12">
        <div className="w-full max-w-xl mx-auto text-center">
          ...
          <div className="relative inline-flex items-center justify-center mb-6">
            <div className="text-8xl sm:text-9xl font-bold tracking-tighter bg-gradient-to-r from-orange-200 via-orange-300 to-amber-200 bg-clip-text text-transparent select-none">
              404
            </div>
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="px-4 py-1.5 rounded-full bg-white/90 border border-orange-200 shadow-md flex items-center gap-2 text-xs font-bold text-[#f56b2a] uppercase tracking-wider backdrop-blur-sm">
          ...
          <p className="text-sm sm:text-base text-gray-500 font-normal leading-relaxed max-w-md mx-auto mb-8">
