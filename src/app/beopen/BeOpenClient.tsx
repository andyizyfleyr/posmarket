...
export default function BeOpenClient() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-[#f56b2a] selection:text-white pb-24 md:pb-0">
      ...
      {/* 3. Hero Section (Image réelle de boutique + Copywriting percutant) */}
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-7 text-center lg:text-left">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-orange-100 border border-orange-200 text-orange-700 text-xs font-extrabold mb-4">
                <Flame size={15} className="text-[#f56b2a]" />
                <span>La Solution n°1 des Commerces d&apos;Afrique</span>
              </div>
              ...
              <p className="text-sm sm:text-base md:text-lg text-slate-600 mb-6 font-medium leading-relaxed max-w-xl mx-auto lg:mx-0">
                Transformez votre smartphone en <strong className="text-slate-900 font-extrabold">Caisse Enregistreuse Tactile</strong> et en <strong className="text-emerald-600 font-extrabold">Boutique en Ligne avec Mobile Money</strong>. Suivez vos ventes, vos stocks et vos bénéfices en temps réel, où que vous soyez.
              </p>
            ...
            {/* Right: Real High-Res Photography with Live Floating Badges */}
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-2xl border-4 border-white bg-slate-900 group">
                ...
                <div className="absolute top-3.5 right-3.5 bg-white/95 backdrop-blur-md rounded-2xl p-2.5 sm:p-3 shadow-lg border border-slate-100 flex items-center gap-2.5 animate-bounce-subtle">
                  ...
                  <div className="text-left">
                    <p className="text-[10px] font-extrabold uppercase text-emerald-600">Vente Validée</p>
                    <p className="text-xs font-black text-slate-900">15 000 FCFA (MoMo)</p>
                  </div>
                </div>
                ...
                <div className="absolute bottom-3.5 left-3.5 bg-slate-950/90 backdrop-blur-md text-white rounded-2xl p-3 border border-slate-700 flex items-center gap-2.5">
                  ...
                  <span className="text-xs font-bold">Caisse &amp; Boutique Synchronisées</span>
                </div>
              </div>
            </div>
      ...
      {/* 4. Section Fonctionnalités Majeures (3 Piliers avec Grandes Photos Réelles) */}
      <section id="features" className="py-14 sm:py-20 bg-white border-b border-slate-200">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          
          <div className="text-center max-w-2xl mx-auto mb-16">
            <span className="text-xs font-black uppercase tracking-wider text-[#f56b2a] bg-orange-50 border border-orange-200 px-3.5 py-1.5 rounded-full">
              Les Fonctionnalités en Action
            </span>
            <h2 className="text-2xl sm:text-4xl font-black text-slate-900 mt-4 mb-2">
              Comment PosMarket propulse votre boutique
            </h2>
          ...
          <div className="space-y-16">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              <div className="lg:col-span-6 order-2 lg:order-1">
                <div className="w-10 h-10 rounded-xl bg-orange-100 text-[#f56b2a] flex items-center justify-center mb-4 font-black">
                  <Zap size={20} />
                </div>
                <h3 className="text-xl sm:text-2xl font-black text-slate-900 mb-3">
                  1. Caisse Tactile Express &amp; Reçus WhatsApp
                </h3>
                <p className="text-slate-600 text-sm leading-relaxed mb-5 font-medium">
                  Encaissez chaque client en <strong>3 clics</strong> sur votre smartphone, tablette ou ordinateur. Recherche rapide d&apos;articles, impression de tickets de caisse ou envoi instantané sur le WhatsApp du client.
                </p>
                <div className="grid grid-cols-2 gap-2.5 text-xs font-bold text-slate-700">
                  ...
                  <div className="bg-slate-50 p-2.5 rounded-xl border border-slate-200 flex items-center gap-2">
                    <CheckCircle2 size={16} className="text-emerald-500 shrink-0" />
                    <span>Reçus WhatsApp</span>
                  </div>
                  <div className="bg-slate-50 p-2.5 rounded-xl border border-slate-200 flex items-center gap-2">
                    <CheckCircle2 size={16} className="text-emerald-500 shrink-0" />
                    <span>Clôture de caisse auto</span>
                  </div>
                  <div className="bg-slate-50 p-2.5 rounded-xl border border-slate-200 flex items-center gap-2">
                    <CheckCircle2 size={16} className="text-emerald-500 shrink-0" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              ...
              <div className="lg:col-span-6">
                <div className="w-10 h-10 rounded-xl bg-emerald-100 text-emerald-600 flex items-center justify-center mb-4 font-black">
                  <ShoppingBag size={20} />
                </div>
                <h3 className="text-xl sm:text-2xl font-black text-slate-900 mb-3">
                  2. Votre Boutique en Ligne Ouverte 24h/24
                </h3>
                <p className="text-slate-600 text-sm leading-relaxed mb-5 font-medium">
                  Vos clients continuent d&apos;acheter pendant que vous dormez ! Partagez votre lien de boutique sur WhatsApp, TikTok et Instagram : les commandes arrivent automatiquement et votre stock se déduit en direct.
                </p>
                <div className="grid grid-cols-2 gap-2.5 text-xs font-bold text-slate-700">
                  <div className="bg-slate-50 p-2.5 rounded-xl border border-slate-200 flex items-center gap-2">
                    <CheckCircle2 size={16} className="text-emerald-500 shrink-0" />
                  ...
                  <div className="bg-slate-50 p-2.5 rounded-xl border border-slate-200 flex items-center gap-2">
                    <CheckCircle2 size={16} className="text-emerald-500 shrink-0" />
                    <span>Stock synchronisé 100%</span>
                  </div>
                </div>
              </div>
            </div>

            {/* Feature 3 : Bénéfices, Mobile Money & Suivi */}
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              <div className="lg:col-span-6 order-2 lg:order-1">
                <div className="w-10 h-10 rounded-xl bg-blue-100 text-blue-600 flex items-center justify-center mb-4 font-black">
                  <BarChart3 size={20} />
                </div>
                <h3 className="text-xl sm:text-2xl font-black text-slate-900 mb-3">
                  3. Bénéfices Nets &amp; Mobile Money Sécurisé
                </h3>
                <p className="text-slate-600 text-sm leading-relaxed mb-5 font-medium">
                  Fini les doutes sur votre rentabilité ou les arnaques aux faux SMS. Les paiements MTN MoMo et Moov Money sont vérifiés par l&apos;opérateur bancaire, et votre bénéfice net est calculé automatiquement.
                </p>
                <div className="grid grid-cols-2 gap-2.5 text-xs font-bold text-slate-700">
                  <div className="bg-slate-50 p-2.5 rounded-xl border border-slate-200 flex items-center gap-2">
                    <CheckCircle2 size={16} className="text-emerald-500 shrink-0" />
                    <span>Zéro faux SMS MoMo</span>
                  </div>
                  <div className="bg-slate-50 p-2.5 rounded-xl border border-slate-200 flex items-center gap-2">
                    <CheckCircle2 size={16} className="text-emerald-500 shrink-0" />
                    <span>Calcul des marges nettes</span>
                  </div>
                  <div className="bg-slate-50 p-2.5 rounded-xl border border-slate-200 flex items-center gap-2">
                    <CheckCircle2 size={16} className="text-emerald-500 shrink-0" />
                    <span>Suivi des vendeurs / caissiers</span>
                  </div>
                  <div className="bg-slate-50 p-2.5 rounded-xl border border-slate-200 flex items-center gap-2">
                    <CheckCircle2 size={16} className="text-emerald-500 shrink-0" />
                    <span>Alertes anti-rupture stock</span>
                  </div>
                </div>
              </div>
              <div className="lg:col-span-6 order-1 lg:order-2">
