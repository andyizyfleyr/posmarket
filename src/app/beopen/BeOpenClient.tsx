    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-[#f56b2a] selection:text-white pb-24 md:pb-0">
            ...
            <div className="lg:col-span-7 text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 mb-6 sm:mb-8">
                ...
                <a
                  ...
                  className="w-full sm:w-auto px-5 py-3.5 rounded-xl bg-white hover:bg-slate-50 active:scale-[0.98] border border-slate-300 text-slate-800 font-medium text-sm flex items-center justify-center gap-2 transition-all shadow-xs"
                >
              ...
              {/* Trust Badges */}
              <div className="grid grid-cols-3 gap-2 sm:gap-3 text-[11px] sm:text-xs font-medium text-slate-600 max-w-md mx-auto lg:mx-0">
                <div className="bg-white p-2.5 rounded-xl border border-slate-200 text-center shadow-xs">
                  <span className="text-emerald-600 block font-semibold text-xs sm:text-sm">Mobile Money</span>
                ...
                <div className="bg-white p-2.5 rounded-xl border border-slate-200 text-center shadow-xs">
                  <span className="text-purple-600 block font-semibold text-xs sm:text-sm">Prêt en 5 min</span>
            ...
            <div className="lg:col-span-5">
              <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl border-4 border-white bg-slate-900 group max-w-md mx-auto lg:max-w-none">
                ...
                <div className="absolute top-2.5 right-2.5 sm:top-4 sm:right-4 bg-white/95 backdrop-blur-md rounded-xl sm:rounded-2xl p-2 sm:p-3 shadow-lg border border-slate-100 flex items-center gap-2 sm:gap-2.5">
                  <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-lg bg-emerald-100 text-emerald-600 flex items-center justify-center font-semibold text-xs shrink-0">
                    ✓
                  </div>
                  <div className="text-left">
                    <p className="text-[10px] font-semibold text-emerald-600 leading-tight">Vente validée</p>
                    <p className="text-[11px] sm:text-xs font-semibold text-slate-900 leading-tight">15 000 FCFA (Mobile Money)</p>
                  </div>
                </div>
                ...
                <div className="absolute bottom-2.5 left-2.5 sm:bottom-4 sm:left-4 bg-slate-950/90 backdrop-blur-md text-white rounded-xl sm:rounded-2xl p-2 sm:p-3 border border-slate-700 flex items-center gap-2">
                  ...
                  <span className="text-[10px] sm:text-xs font-medium">Caisse et boutique synchronisées</span>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-12 sm:space-y-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-center">
              <div className="lg:col-span-6 order-2 lg:order-1">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-2.5 text-xs font-medium text-slate-700">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-center">
              ...
              <div className="lg:col-span-6">
                <div className="w-10 h-10 rounded-xl bg-emerald-100 text-emerald-600 flex items-center justify-center mb-3 sm:mb-4 font-semibold">
                  <ShoppingBag size={20} />
                </div>
                <h3 className="text-lg sm:text-2xl font-bold text-slate-900 mb-2 sm:mb-3">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-center">
              <div className="lg:col-span-6 order-2 lg:order-1">
                <div className="w-10 h-10 rounded-xl bg-blue-100 text-blue-600 flex items-center justify-center mb-3 sm:mb-4 font-semibold">
                  <BarChart3 size={20} />
                </div>
                <h3 className="text-lg sm:text-2xl font-bold text-slate-900 mb-2 sm:mb-3">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          {timelineTab === 'seller' && (
            <div className="relative border-l-2 border-orange-200 pl-5 sm:pl-8 ml-3 sm:ml-5 space-y-6 sm:space-y-8">
              ...
              {/* Étape 2 : 11h15 */}
              <div className="relative">
                <div className="absolute -left-[31px] sm:-left-[43px] top-1 w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-emerald-500 text-white flex items-center justify-center font-semibold text-xs shadow-xs ring-4 ring-white">
                  <Zap size={13} />
                </div>
                <div className="bg-slate-50 p-4 sm:p-5 rounded-2xl border border-slate-200 shadow-xs">
                  <div className="flex items-center justify-between gap-2 mb-1.5">
                    <span className="text-xs font-semibold text-emerald-600">11h15 • Pic d&apos;affluence au comptoir</span>
                    <span className="text-[10px] font-medium text-slate-500 bg-white px-2 py-0.5 rounded border border-slate-200 shrink-0">Caisse tactile</span>
                  </div>
                  <h4 className="text-sm sm:text-base font-semibold text-slate-900 mb-1">
              ...
              {/* Étape 3 : 14h40 */}
              <div className="relative">
                <div className="absolute -left-[31px] sm:-left-[43px] top-1 w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-blue-500 text-white flex items-center justify-center font-semibold text-xs shadow-xs ring-4 ring-white">
                  <Truck size={13} />
                </div>
                <div className="bg-slate-50 p-4 sm:p-5 rounded-2xl border border-slate-200 shadow-xs">
                  <div className="flex items-center justify-between gap-2 mb-1.5">
                    <span className="text-xs font-semibold text-blue-600">14h40 • Préparation d&apos;une commande web</span>
                    <span className="text-[10px] font-medium text-slate-500 bg-white px-2 py-0.5 rounded border border-slate-200 shrink-0">En ligne</span>
                  </div>
                  <h4 className="text-sm sm:text-base font-semibold text-slate-900 mb-1">
              ...
              {/* Étape 4 : 19h00 */}
              <div className="relative">
                <div className="absolute -left-[31px] sm:-left-[43px] top-1 w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-purple-500 text-white flex items-center justify-center font-semibold text-xs shadow-xs ring-4 ring-white">
                  <BarChart3 size={13} />
                </div>
                <div className="bg-slate-50 p-4 sm:p-5 rounded-2xl border border-slate-200 shadow-xs">
                  <div className="flex items-center justify-between gap-2 mb-1.5">
                    <span className="text-xs font-semibold text-purple-600">19h00 • Bilan de fin de journée</span>
                    <span className="text-[10px] font-medium text-slate-500 bg-white px-2 py-0.5 rounded border border-slate-200 shrink-0">Statistiques</span>
                  </div>
                  <h4 className="text-sm sm:text-base font-semibold text-slate-900 mb-1">
              ...
              {/* Étape 5 : 23h30 */}
              <div className="relative">
                <div className="absolute -left-[31px] sm:-left-[43px] top-1 w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-slate-800 text-white flex items-center justify-center font-semibold text-xs shadow-xs ring-4 ring-white">
                  <Moon size={13} />
                </div>
                <div className="bg-slate-50 p-4 sm:p-5 rounded-2xl border border-slate-200 shadow-xs">
                  <div className="flex items-center justify-between gap-2 mb-1.5">
                    <span className="text-xs font-semibold text-slate-700">23h30 • Ventes automatiques la nuit</span>
                    <span className="text-[10px] font-semibold text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded shrink-0">24h/24</span>
                  </div>
                  <h4 className="text-sm sm:text-base font-semibold text-slate-900 mb-1">
          ...
          {timelineTab === 'customer' && (
            <div className="relative border-l-2 border-emerald-200 pl-5 sm:pl-8 ml-3 sm:ml-5 space-y-6 sm:space-y-8">
              ...
              <div className="relative">
                ...
                <div className="bg-slate-50 p-4 sm:p-5 rounded-2xl border border-slate-200 shadow-xs">
                  <div className="flex items-center justify-between gap-2 mb-1.5">
                    <span className="text-xs font-semibold text-emerald-600">Étape 1 • Découverte de la boutique</span>
                    <span className="text-[10px] font-medium text-slate-500 bg-white px-2 py-0.5 rounded border border-slate-200 shrink-0">Accès direct</span>
                  </div>
                  <h4 className="text-sm sm:text-base font-semibold text-slate-900 mb-1">
              ...
              <div className="relative">
                ...
                <div className="bg-slate-50 p-4 sm:p-5 rounded-2xl border border-slate-200 shadow-xs">
                  <div className="flex items-center justify-between gap-2 mb-1.5">
                    <span className="text-xs font-semibold text-blue-600">Étape 3 • Validation de commande</span>
                    <span className="text-[10px] font-medium text-slate-500 bg-white px-2 py-0.5 rounded border border-slate-200 shrink-0">Facile</span>
                  </div>
                  <h4 className="text-sm sm:text-base font-semibold text-slate-900 mb-1">
              ...
              <div className="relative">
                ...
                <div className="bg-slate-50 p-4 sm:p-5 rounded-2xl border border-slate-200 shadow-xs">
                  <div className="flex items-center justify-between gap-2 mb-1.5">
                    <span className="text-xs font-semibold text-purple-600">Étape 4 • Preuve d&apos;achat instantanée</span>
                    <span className="text-[10px] font-medium text-slate-500 bg-white px-2 py-0.5 rounded border border-slate-200 shrink-0">Reçu</span>
                  </div>
                  <h4 className="text-sm sm:text-base font-semibold text-slate-900 mb-1">
              ...
              {/* Étape 5 : Réception */}
              <div className="relative">
                <div className="absolute -left-[31px] sm:-left-[43px] top-1 w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-teal-500 text-white flex items-center justify-center font-semibold text-xs shadow-xs ring-4 ring-white">
                  <CheckCircle2 size={13} />
                </div>
                <div className="bg-slate-50 p-4 sm:p-5 rounded-2xl border border-slate-200 shadow-xs">
                  <div className="flex items-center justify-between gap-2 mb-1.5">
                    <span className="text-xs font-semibold text-teal-600">Étape 5 • Réception et suivi de commande</span>
                    <span className="text-[10px] font-medium text-slate-500 bg-white px-2 py-0.5 rounded border border-slate-200 shrink-0">Livraison</span>
                  </div>
                  <h4 className="text-sm sm:text-base font-semibold text-slate-900 mb-1">
      ...
      <section id="comparatif" className="py-10 sm:py-16 bg-slate-50 border-b border-slate-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-8">
            <h2 className="text-xl sm:text-3xl font-bold text-slate-900 mb-2 tracking-tight">
          ...
          <div className="bg-white rounded-2xl sm:rounded-3xl border border-slate-200 overflow-hidden shadow-xs">
            <div className="grid grid-cols-2 bg-slate-900 text-white font-semibold py-3.5 px-3 sm:px-6 text-[11px] sm:text-xs">
            ...
            <div className="divide-y divide-slate-100">
              {[
                ...
                <div key={idx} className="grid grid-cols-2 p-3 sm:p-4 gap-2.5 sm:gap-4 items-center">
                  ...
                  <div className="text-emerald-700 font-medium leading-relaxed text-[11px] sm:text-xs md:text-sm">{row.after}</div>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6 items-stretch">
            ...
            <div className="bg-slate-50 rounded-2xl sm:rounded-3xl p-5 sm:p-8 border border-slate-200 flex flex-col justify-between hover:border-slate-300 transition-all">
              <div>
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-[11px] font-medium text-slate-500">1 boutique</span>
                </div>
                ...
                <div className="mb-5">
                  <div className="flex items-baseline gap-1">
                    ...
                    <span className="text-xs font-medium text-slate-500">FCFA par mois</span>
                  </div>
                  {duration !== 'monthly' && (
              ...
              <Link
                ...
                className="w-full py-3 px-4 rounded-xl bg-slate-900 hover:bg-slate-800 active:scale-[0.98] text-white font-medium text-xs text-center transition-all min-h-[42px] flex items-center justify-center"
              >
            ...
            <div className="bg-white rounded-2xl sm:rounded-3xl p-5 sm:p-8 border-2 border-[#f56b2a] flex flex-col justify-between relative shadow-xl shadow-orange-500/10 md:scale-[1.02]">
              ...
              <div>
                <div className="flex items-center justify-between mb-3">
                  <span className="text-xs font-semibold text-orange-700 bg-orange-50 px-3 py-1 rounded-full border border-orange-200">
                    Pro
                  </span>
                  <span className="text-[11px] font-medium text-emerald-600">Caisse & web</span>
                </div>
            ...
            <div className="bg-slate-50 rounded-2xl sm:rounded-3xl p-5 sm:p-8 border border-slate-200 flex flex-col justify-between hover:border-slate-300 transition-all">
              <div>
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-[11px] font-medium text-slate-500">Multi-magasins</span>
                </div>
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-t border-slate-200 p-3 shadow-2xl flex items-center justify-between gap-3 pb-[calc(0.75rem+env(safe-area-inset-bottom))]">
        <div className="text-left pl-1">
          <span className="text-[10px] font-medium text-slate-500 block leading-tight">Formule Starter</span>
          <span className="text-sm font-semibold text-slate-900 leading-tight">12 000 FCFA <span className="text-[10px] font-normal text-slate-500">/mois</span></span>
        </div>
        <Link
          href="/subscription"
