    ...
    <html lang="fr">
      <body className="min-h-screen bg-[#fffaf7] text-gray-900 font-sans flex items-center justify-center p-4">
        <div className="w-full max-w-md bg-white rounded-3xl p-8 border border-orange-100 shadow-2xl text-center">
          <div className="w-16 h-16 mx-auto mb-5 rounded-2xl bg-orange-100 text-[#f56b2a] flex items-center justify-center text-2xl font-black">
            ⚡
          </div>
          ...
          <div className="flex flex-col gap-3">
            <button
              ...
              className="w-full py-3.5 px-6 bg-[#f56b2a] hover:bg-[#e45a19] text-white font-black text-sm rounded-2xl shadow-lg shadow-[#f56b2a]/30 transition-all cursor-pointer"
            >
              Recharger la page
            </button>
            <a
              href="/"
              className="w-full py-3 px-6 bg-gray-50 hover:bg-gray-100 text-gray-800 font-bold text-sm rounded-2xl border border-gray-200 transition-all text-center"
            >
              Retour au catalogue
            </a>
          </div>
